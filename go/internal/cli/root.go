...
var compatibilityCommands = []string{
	"prepare", "dispatch", "start", "help", "context", "notes", "notice", "archive", "ask", "answer", "report", "resolve", "review", "verify", "pr", "cleanup", "pump", "attention", "bind", "backup", "herdr", "dev", "refresh", "update",
}
