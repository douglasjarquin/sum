...
| Grok Bot packs | Native recipes under [`templates/sum/`](templates/sum/) (coordinator) and [`templates/square/`](templates/square/) (backup agent). Install with [`GROK_SUM.md`](GROK_SUM.md) and [`GROK_SQUARE.md`](GROK_SQUARE.md). Index: [`templates/README.md`](templates/README.md) |
