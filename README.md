...
| Explicit Git skill delivery | `bin/sumctl skills inspect/install` selects exact repository refs and skill directories into pinned, hash-checked snapshots; see `docs/sum-skills.md` |
