...
- **Means:** Encode each adopt item as explicit coordinator-facing sentences in `grok-bots/sum/` plus three Sum-native pack skills the installer loads by name, locked by `tests/test_operating_files.py` against the shipped files (KTD1–KTD3).
...
In scope: `grok-bots/sum/` (instructions, memories, routines, Dispatch, Deliver, new Sitdown / cheap-routines / adversarial-review skills), `GROK_SUM.md`, `tests/test_operating_files.py`, and `docs/features/coordination.md` row `grok-bot.static` if the scenario text must name the new habits.
...
- **Dependencies:** none
- **Files:**
  - `grok-bots/sum/skills/sitdown/SKILL.md` (create)
  - `grok-bots/sum/skills/cheap-routines/SKILL.md` (create)
  - `grok-bots/sum/skills/adversarial-review/SKILL.md` (create)
  - `GROK_SUM.md` (modify)
  - `grok-bots/sum/README.md` (modify if it lists skills)
- **Approach:**
...
- **Patterns to follow:** `grok-bots/sum/skills/dispatch/SKILL.md` and `grok-bots/sum/skills/deliver/SKILL.md` for heading shape and tone.
...
- **Dependencies:** U1
- **Files:**
  - `grok-bots/sum/instructions.md`
  - `grok-bots/sum/memories.md`
  - `grok-bots/sum/routines.md`
  - `grok-bots/sum/README.md`
  - `grok-bots/sum/skills/dispatch/SKILL.md`
  - `grok-bots/sum/skills/deliver/SKILL.md`
- **Approach:**
