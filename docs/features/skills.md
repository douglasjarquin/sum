...
| `skills.sum-inventory` | Checking Sum itself still validates its owned names, projections, portable imports, and compatibility references | automated: `go/internal/skills/skills.go`, `tests/test_setup.py` | offline suite |
