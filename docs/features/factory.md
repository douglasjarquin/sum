...
| `factory.merge-evidence-file` | A listed comparison.json that is missing, outside the checkout, unbound, or not a passing verdict is human-gate | automated: `go/internal/factory/factory_test.go` | offline suite |
