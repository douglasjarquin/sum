...
./bin/sumctl review TASK_ID --verdict changes-requested --candidate SHA --file f.md --finding 'blocking: …'   # reviewer pane: full findings plus compact PR notes; binds the reviewer endpoint; a return to the parent
