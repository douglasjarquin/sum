...
| Six bundled skills | Dispatch, worker execution, verification/PR delivery, rundown/recovery, isolated self-development, atomic updates with rolling session refresh and code-only rollback, and the optional per-project factory lane |
