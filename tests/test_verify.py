...
class VerifyLab(unittest.TestCase):
    ...
    def test_sum_repository_contract_checks_against_its_own_tasks(self):
        ...
        self.assertEqual([i for i, d in drivers.items() if d == "manual"], ["live.herdr-smoke", "live.harness-canary", "verify.sum-self", "root.real-harness-canary", "evidence.sum-self"])
